 ...
 * Discovers and validates all SKILL.md files in skills/ and examples/.
...
const { parseSkill, validateSkill, lintSkill } = require(join(ROOT, "packages/core/dist/index.cjs"));
...
async function main() {
  const skillPaths = [
    ...discoverSkills(join(ROOT, "skills")),
    ...discoverSkills(join(ROOT, "examples")),
  ];
